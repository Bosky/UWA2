...
{
    /// <summary>
    /// UwaDatabase builds on SQLite.Net and represents a specific database, in our case, 
    /// the Application's main database, UwaDatabase.db3 located in the APPDATA folder.
    ...
    public class UwaDatabase : SQLiteConnection
    {
        ...
        /// <summary>
        /// File path depends on operating system. 
        /// 
        /// </summary>
        ...
        public static int DeleteItem<T>(int id) where T : BusinessLayer.Contracts.IBusinessEntity, new()
        {
            lock (locker)
            {
        ...
        public static void ClearTable<T>() where T : BusinessLayer.Contracts.IBusinessEntity, new()
        {
            lock (locker)
            {
        ...
        public static int CountTable<T>() where T : BusinessLayer.Contracts.IBusinessEntity, new()
        {
            lock (locker)
            {
